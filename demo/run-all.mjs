...
const SUITES = [
  ...
  "pages-test", "pro-test", "recovery-test", "dashboard-test", "agent-test", "providers-test", "extensions-test", "accounts-test", "payments-test", "seo-test", "update-test", "vex-test", "memory-test", "safe-update-test", "installer-test", "stream-test", "image-gen-test", "agent-image-test", "ui-test",
];
