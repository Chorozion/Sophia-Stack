...
ok(dash.status === 200 && dh.includes("Sophia · Dashboard") && dh.includes("Pages") && dh.includes("Media") && dh.includes("Keys") && dh.includes("Tell Sophia what to build"), "dashboard loads with Build + all tabs");
